...
DebugDraw::DebugDraw(irr::IrrlichtDevice* const device) :
...
void DebugDraw::setDebugMode(int mode) { this->mode = mode; }

int DebugDraw::getDebugMode() const { return this->mode; }