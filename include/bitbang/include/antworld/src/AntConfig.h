...
public:
    ...
    static float LogBrainsInitTime;
	...
	static int HomeX;
	static int HomeY;
    static int HomeRadious;
	static int FeedingZones;
	static int MinAgents;
	static int PheromoneEvaporationRate;
	static int PheromoneGranularity;
    static float PheromoneMaxInfluence;
    static int ScreenShootFrequency;
    static int UseFixedCamera;
	
	//Ant
	static bool UseTestBrain;
    static bool UseCustomBrain;
